    ...
    <div className="flex min-h-screen flex-col items-center justify-center bg-zinc-950 px-4">
      ...
      <div className="w-full max-w-sm rounded-2xl border border-zinc-800 bg-zinc-900 p-8">
        ...
        <form
          ...
          action={async () => {
            "use server";
            await signIn("google", { redirectTo: "/academy" });
          }}
        >
          <button
            type="submit"
            className="flex w-full items-center justify-center gap-3 rounded-xl border border-zinc-700 bg-zinc-800 py-3 text-sm font-medium text-white hover:bg-zinc-700 transition-colors"
          >
